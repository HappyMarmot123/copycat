...
YouTube 영상 URL을 입력받아 오디오만 추출하고 `mp3` 또는 `mp4`(AAC 오디오 컨테이너)로 저장하는 도구입니다.  
...
```bash
go run . -url "https://www.youtube.com/watch?v=VIDEO_ID" -format mp3 -timeout 30 -output music.mp3
```
